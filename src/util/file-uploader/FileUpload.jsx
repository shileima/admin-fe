...
class FileUpload extends React.Component{
    ...
    commonChange(e) {
        ...
        /*如果限制了多文件上传时的数量*/
        const numberLimit = typeof FileUpload.propTypes.numberLimit === 'function' ? FileUpload.propTypes.numberLimit() : FileUpload.propTypes.numberLimit
        if(FileUpload.propTypes.multiple && numberLimit && files.length > numberLimit) {
            const newFiles = {}
